    ...
    <div className="font-sans bg-white text-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a
                href="/verhaal"
                className="hover:opacity-70 transition-opacity font-bold text-black"
                style={{
      ...
      <section className="pt-48 pb-32 px-4 sm:px-6 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-40">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-20 leading-tight text-gray-900">
          ...
          {customerType === 'particulier' && (
            <section id="contact" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-white">
              <div className="max-w-7xl mx-auto">
                <div className="rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 bg-gray-100">
                  ...
                  <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16 md:mb-20">
                    ...
                    <div className="space-y-6 sm:space-y-8">
                      ...
                      <div className="text-left">
                        <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-4 sm:mb-6 text-gray-900">
                            Neem contact op!
            </h2>
                      </div>
                        ...
                        <form className="space-y-3 sm:space-y-4">
                          <div>
                            <input
                              type="text"
                              placeholder="Naam"
                              className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg bg-white text-sm sm:text-base text-gray-900 placeholder-gray-500 focus-ring-logo"
                            />
                          </div>
                          <div>
                            <input
                          ...
                          <div>
                            <textarea
                              placeholder="Bericht"
                              rows={3}
                              className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg resize-none bg-white text-sm sm:text-base text-gray-900 placeholder-gray-500 focus-ring-logo"
                            />
                          </div>
                          <div className="pt-4">
                            <button className="w-full px-6 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2 bg-gray-900 hover:bg-gray-800 text-white">
                              Verzend
                              <Image
                                src="/Arrow.png" 
                                alt="Arrow" 
          ...
          {customerType === 'particulier' && (
            <section id="faq" className="py-24 pb-40 px-6 bg-white rounded-b-3xl">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center mb-16">
                  ...
                  <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 sm:mb-6 leading-none text-gray-900">
